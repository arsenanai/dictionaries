...
'Items per page':'Кодтар бетінде кестедегі элементтер саны',
'Settings':'Баптаулар',
'Language':'Тіл',
'Save':'Сақтау',
'Saved':'Сақталған',
'Select All':'Барлығын таңдау',
'Select All On Page':'Беттегілерді таңдау',
'Create':'Ашу',
'Creating...':'Ашылуда...',
'Specify password':'Құпия сөз енгізіңіз',
'Username':'Аты',
'Password':'Құпия сөз',
'type to change password':'(өзгерту үшін жазыңыз немесе бос қалдырыңыз)',
'The name has already been taken.':'Мұндай ат қолдалуда',
'The email has already been taken.':'Мұндай email қолданылуда',
'edited':'өзгертілді',
'migrated':'көшірілді',
...
'Please wait until end':'Соңына дейін күтіңіз',
...
'Users edit':'Изменение пользователя',
'Yes':'Да',
...
'Items per page':'Элементы в таблице на странице Коды',
'Settings':'Настройки',
'Language':'Язык',
'Save':'Сохранить',
'Saved':'Сохранено',
...
'Username':'Имя',
'Password':'Пароль',
'type to change password':'(введите чтобы изменить, или оставьте пустым)',
'The name has already been taken.':'Такое имя уже используется',
'The email has already been taken.':'Такой email уже используется',
'edited':'изменены',
'migrated':'перенесены',
...
'Synchronize Codes with Production':'Синхронизировать коды с боевой базы в текущую',
...
'Please wait until end':'Подождите до конца',
