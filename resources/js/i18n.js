...
'Description kk':'Спецификация на казахском',
'Description ru':'Спецификация на русском',
'Filter':'Фильтр',
'Group':'Группа',
...
'Yes':'Да',
'You have to apply some filters before selecting all':'Необходимо применить фильтр перед выделением всех',
'You have to apply some filters before selecting all items':'Необходимо применить фильтр перед выделением всех элементов',
'ZKS':'ЗКС',
